...
export const testimonials = [
  {
    ...
    company: "TechCorp",
    content: "Working with this developer has been an absolute pleasure. The attention to detail and technical expertise is outstanding. Our project was delivered on time and exceeded expectations.",
    rating: 5,
  },
  {
    id: 2,
    name: "Michael Chen",
    content: "Exceptional full-stack development skills! The scalability and performance optimizations implemented were top-notch. Highly recommend for complex projects.",
    rating: 5,
  },
  {
    id: 3,
    ...
    company: "GrowthHub",
    content: "Transformed our MVP into a production-ready application. The code quality and architecture decisions were spot-on. A true professional!",
    rating: 5,
  },
  {
    id: 4,
    ...
    company: "CloudScale",
    content: "Outstanding problem-solving abilities and deep technical knowledge. The DevOps implementation and CI/CD pipelines were flawlessly executed.",
    rating: 5,
  },
  {
    id: 5,
    ...
    content: "Perfect implementation of our design vision. The animations and user experience are incredibly smooth. Great collaboration throughout the project.",
    rating: 5,
  },
  {
    id: 6,
    ...
    content: "Built our entire platform from scratch with modern tech stack. The scalability and maintainability of the codebase is impressive. Highly skilled developer!",
    rating: 5,
  },
  {
    id: 7,
    ...
    content: "Excellent communication and technical execution. The project was delivered with clean documentation and comprehensive testing. Would definitely work again!",
    rating: 5,
  },
  {
    id: 8,
    ...
    content: "Impressive expertise in both frontend and backend development. The API architecture and database optimization were particularly well done.",
    rating: 5,
  },
  {
    id: 9,
    ...
    content: "Our e-commerce platform performance improved dramatically. The optimization and new features boosted our conversion rate significantly. Amazing work!",
    rating: 5,
  },
  {
    id: 10,
    ...
    content: "Deep knowledge of modern web technologies and best practices. The real-time features and state management implementation were perfectly executed.",
    rating: 5,
  },
];
