...
export const ParticleBurst = () => {
   ...
   useEffect(() => {
      ...
      if (theme === "dark") {
         ...
         const animateDark = () => {
            ...
            for (const orb of glowOrbs) {
               ...
               gradient.addColorStop(
                  0,
                  `rgba(${neonColor.r}, ${neonColor.g}, ${neonColor.b}, ${currentOpacity})`,
               );
               gradient.addColorStop(
                  0.5,
                  `rgba(${neonColor.r}, ${neonColor.g}, ${neonColor.b}, ${currentOpacity * 0.3})`,
               );
            ...
            for (const star of stars) {
               ...
               glowGradient.addColorStop(
                  0,
                  `rgba(${neonColor.r}, ${neonColor.g}, ${neonColor.b}, ${currentOpacity * 0.4})`,
               );
            ...
            for (let i = shootingStars.length - 1; i >= 0; i--) {
               ...
               gradient.addColorStop(
                  1,
                  `rgba(${neonColor.r}, ${neonColor.g}, ${neonColor.b}, ${star.opacity})`,
               );
               ...
               headGlow.addColorStop(
                  0.3,
                  `rgba(${neonColor.r}, ${neonColor.g}, ${neonColor.b}, ${star.opacity * 0.8})`,
               );
         ...
         const sunColor = { r: 255, g: 160, b: 0 };
         const sunColorSecondary = { r: 255, g: 120, b: 0 };
         const sunColorBright = { r: 255, g: 200, b: 50 };
         ...
         const clouds: Cloud[] = [
            createCloud(window.innerWidth * 0.1, window.innerHeight * 0.2, 1.2),
            createCloud(
         ...
         const drawCloud = (cloud: Cloud) => {
            ...
            for (const puff of cloud.puffs) {
               ...
               cloudGradient.addColorStop(
                  0.5,
                  `rgba(255, 252, 245, ${cloud.opacity * 0.9})`,
               );
               cloudGradient.addColorStop(
                  0.8,
                  `rgba(250, 245, 235, ${cloud.opacity * 0.6})`,
               );
         ...
         const animateLight = () => {
            ...
            for (const orb of floatingOrbs) {
               ...
               gradient.addColorStop(
                  0,
                  `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, ${currentOpacity})`,
               );
               gradient.addColorStop(
                  0.5,
                  `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, ${currentOpacity * 0.3})`,
               );
               gradient.addColorStop(1, "transparent");
            ...
            for (let i = 0; i < beamCount; i++) {
               const beamAngle =
                  Math.PI / 6 +
                  ((i / beamCount) * Math.PI) / 1.5 +
                  Math.sin(time * 0.003 + i) * 0.05;
               const beamLength =
               ...
               beamGradient.addColorStop(
                  0,
                  `rgba(${sunColorBright.r}, ${sunColorBright.g}, ${sunColorBright.b}, 0.15)`,
               );
               beamGradient.addColorStop(
                  0.2,
                  `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, 0.08)`,
               );
               beamGradient.addColorStop(
                  0.5,
                  `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, 0.03)`,
               );
            ...
            for (const ray of sunRays) {
               ...
               const endX =
                  sunX + Math.cos(ray.angle + time * 0.0008) * currentLength;
               const endY =
                  sunY + Math.sin(ray.angle + time * 0.0008) * currentLength;
               ...
               gradient.addColorStop(
                  0,
                  `rgba(${sunColorBright.r}, ${sunColorBright.g}, ${sunColorBright.b}, ${currentOpacity})`,
               );
               gradient.addColorStop(
                  0.4,
                  `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, ${currentOpacity * 0.6})`,
               );
               gradient.addColorStop(1, "transparent");
            ...
            outerGlow.addColorStop(
               0,
               `rgba(${sunColorBright.r}, ${sunColorBright.g}, ${sunColorBright.b}, 0.5)`,
            );
            outerGlow.addColorStop(
               0.2,
               `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, 0.35)`,
            );
            outerGlow.addColorStop(
               0.4,
               `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, 0.15)`,
            );
            outerGlow.addColorStop(
               0.7,
               `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, 0.05)`,
            );
            ...
            sunGradient.addColorStop(
               0.2,
               `rgba(${sunColorBright.r}, ${sunColorBright.g}, ${sunColorBright.b}, 0.98)`,
            );
            sunGradient.addColorStop(
               0.5,
               `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, 0.95)`,
            );
            sunGradient.addColorStop(
               0.8,
               `rgba(${sunColorSecondary.r}, ${sunColorSecondary.g}, ${sunColorSecondary.b}, 0.9)`,
            );
            sunGradient.addColorStop(
               1,
               `rgba(${sunColorSecondary.r}, ${sunColorSecondary.g}, ${sunColorSecondary.b}, 0.6)`,
            );
            ...
            for (let i = lightParticles.length - 1; i >= 0; i--) {
               ...
               particleGradient.addColorStop(
                  0.5,
                  `rgba(${sunColor.r}, ${sunColor.g}, ${sunColor.b}, ${currentOpacity * 0.5})`,
               );
   ...
   const gridColor =
      theme === "dark" ? "rgba(0, 255, 136, 1)" : "rgba(255, 184, 0, 0.8)";
