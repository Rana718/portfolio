  ...
  useEffect(() => {
    ...
    if (theme === "dark") {
      ...
      const glowOrbs: GlowOrb[] = [
        { x: window.innerWidth * 0.2, y: window.innerHeight * 0.3, radius: 300, opacity: 0.03, pulsePhase: 0, pulseSpeed: 0.005 },
        { x: window.innerWidth * 0.8, y: window.innerHeight * 0.6, radius: 250, opacity: 0.025, pulsePhase: Math.PI, pulseSpeed: 0.007 },
        { x: window.innerWidth * 0.5, y: window.innerHeight * 0.8, radius: 350, opacity: 0.02, pulsePhase: Math.PI / 2, pulseSpeed: 0.004 },
      ];
      ...
      const animateDark = () => {
        ...
        for (let i = shootingStars.length - 1; i >= 0; i--) {
          ...
          if (star.opacity <= 0 || star.x > window.innerWidth || star.y > window.innerHeight) {
      ...
      const sunRadius = Math.min(window.innerWidth, window.innerHeight) * 0.1;
      ...
      const clouds: Cloud[] = [
        ...
        createCloud(window.innerWidth * 0.4, window.innerHeight * 0.12, 0.9),
        createCloud(window.innerWidth * 0.6, window.innerHeight * 0.25, 1.0),
        createCloud(window.innerWidth * 0.2, window.innerHeight * 0.35, 0.7),
        createCloud(window.innerWidth * 0.75, window.innerHeight * 0.18, 0.8),
      ];
      ...
      const animateLight = () => {
        ...
        for (let i = 0; i < beamCount; i++) {
          ...
          const beamLength = Math.min(window.innerWidth, window.innerHeight) * 1.8;
