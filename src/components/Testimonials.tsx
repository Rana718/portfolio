...
export const Testimonials = () => {
  ...
  return (
    <section
      ...
      id="testimonials"
    >
      {/* Blur glow effect - only for testimonials section */}
      <div
      ...
      <div className="px-4 md:px-8">
        ...
        />
        <p
          className={`text-foreground/60 text-xs md:text-sm leading-relaxed max-w-2xl mx-auto px-2 mb-12 transition-all duration-700 delay-200 ${
      ...
      {/* Gradient overlays on sides - ABSOLUTE not fixed */}
      <div
