    ...
    emailjs
      .send(
        ...
        import.meta.env.VITE_EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "ranadolui718@gmail.com",
      ...
      .then(
        () => {
          setLoading(false);
          alert("Your message has been successfully sent. I appreciate you reaching out and will get back to you as soon as possible. Have a great day!");
        ...
        (error) => {
          setLoading(false);
          console.error(error);
          alert("We couldn't send your message at this time. Please try again later or reach out to me directly at ranadolui718@gmail.com. Thank you for your patience!");
        }
      );
  };
